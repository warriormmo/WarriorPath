...
$maxschool=0;
if ($enemy['Boks']>$maxschool){$maxschool=$enemy['Boks'];}
...
$hitcount=$enemy['Lovkost']+$maxschool+$enemy['moddeystvie']+$enemy['modranenie']+$enemymods['napopodanie']+$enemymods['napopblgudaru']+$enemymods['napopblgudarrukoy']+$enemymods['napopvtors']-1;//кол кубиков на попадание с учетом всех модов -3 от карты
...
{
$damagecount=$enemy['Sila']+$enemymods['nadamage']-round(($my['Sila']/2))+$mymods['naarmor']+$enemy['modranenie']+$enemymods['napovvtors']+$enemymods['napovblgudaru']+$enemymods['napovblgudarrukoy']-2;//расчет кол кубиков на повреждение
