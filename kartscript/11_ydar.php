<?php
  ...
  $hitcount = $enemy['Lovkost'] + $maxschool + $enemy['moddeystvie'] + $enemy['modranenie'] + $enemymods['napopodanie'] - 2;
  if ($hitcount > 0) {
  ...
  //условие вполнения удара
    ...
    if ($hit > $blok) {
      ...
      $damagecount = $enemy['Sila'] + $enemy['nadamage'] - round(($my['Sila'] / 2)) + $mymods['naarmor'] + $enemy['modranenie'] + 2;
      if ($damagecount > 0) {
