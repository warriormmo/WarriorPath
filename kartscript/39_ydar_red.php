...
if ($battle['dist'] > 0) {
  ...
  if ($hit < 3) {
    ...
    {
      $damagecount = $enemy['Sila'] + $enemymods['nadamage'] - round(($my['Sila'] / 2)) + $mymods['naarmor'] + $enemy['modranenie'] + $enemymods['napovvruku'] + $enemymods['napovblgudaru'] + $enemymods['napovblgudarrukoy']; //расчет кол кубиков на повреждение
      if ($damagecount > 0) {
