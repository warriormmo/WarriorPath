...
$razvorot=db_fetch();
if ($razvorot){$enemymods['nadamage']=$enemymods['nadamage']+3;} 
$hitcount=$enemy['Lovkost']+$enemy['schoolred']+$enemy['moddeystvie']+$enemy['modranenie']+$enemymods['napopodanie']-1;//кол кубиков на попадание с учетом всех модов -3 от карты
...
{
$damagecount=$enemy['Sila']+$enemymods['nadamage']-round(($my['Sila']/2))+$mymods['naarmor']+$enemy['modranenie'];//расчет кол кубиков на повреждение
