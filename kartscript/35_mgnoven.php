<?php
  ...
  if ($schoolred > 0) {
    ...
    db_query('UPDATE `game_user` SET `technic` = "35_mgnoven" WHERE id = ' . $id . ' LIMIT 1;');
    //занесение в моды
    db_query('INSERT INTO `modificators`(id,time,nadamage,napopodanie,nayklonenie,nablok,technic)  VALUES (' . $id . ',1000,1,1,-2,-2,1)');
  } else {
