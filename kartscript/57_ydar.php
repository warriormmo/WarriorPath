...
$hitcount=$enemy['Lovkost']+$enemy['schoolred']+$enemy['moddeystvie']+$enemy['modranenie']+$enemymods['napopodanie']-4;//кол кубиков на попадание с учетом всех модов -3 от карты
...
{
$damagecount=$enemy['Sila']+$enemy['nadamage']-round(($my['Sila']/2))+$mymods['naarmor']+$enemy['modranenie']+4;//расчет кол кубиков на повреждение
...
db_query('INSERT INTO `modificators`(id,time,napopodanie)  VALUES ('.$enemy['id'].',1000,-1)');//занесение в моды
