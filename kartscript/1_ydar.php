...
$hitcount=$enemy['Lovkost']+$enemy['schoolred']+$enemy['moddeytvie']+$enemy['modranenie']+$enemymods['napopodanie']-3;//кол кубиков на попадание с учетом всех модов -3 от карты
