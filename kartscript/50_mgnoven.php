...
db_query('UPDATE `game_user` SET `technic` = "50_mgnoven" WHERE id = '.$id.' LIMIT 1;');  //занесение в базу в технику
db_query('INSERT INTO `modificators`(id,time,napopodanie,technic)  VALUES ('.$id.',1000,1,1)');//занесение в моды
