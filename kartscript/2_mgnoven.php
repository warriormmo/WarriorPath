<?php
  ...
  if ($schoolblue > 0) {
    ...
    db_query('UPDATE `game_user` SET `technic` = "2_mgnoven" WHERE id = ' . $id . ' LIMIT 1;');
    //занесение в моды
    db_query('INSERT INTO `modificators`(id,time,nadamage,napopodanie,nayklonenie,nablok,technic)  VALUES (' . $id . ',1000,0,1,0,0,1)');
  } else {
