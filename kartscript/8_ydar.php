...
$hitcount=$enemy['Lovkost']+$enemy['schoolred']+$enemy['moddeytvie']+$enemy['modranenie']+$enemymods['napopodanie'];//кол кубиков на попадание с учетом всех модов -3 от карты
