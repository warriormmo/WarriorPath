...
{
$damagecount=$enemy['Sila']+$enemymods['nadamage']-round(($my['Sila']/2))+$mymods['naarmor']+$enemy['modranenie']+$enemymods['napovvgolovu']+$enemymods['napovdaludaru']+$enemymods['napovdaludarrukoy']+1;//расчет кол кубиков на повреждение
